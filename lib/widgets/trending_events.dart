    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          logError(trendingEvents[index].event_img_1 ?? placeholderImage);
          return Padding(
                ...
                children: [
                  Expanded(flex: 1,child: Container(
                    ...
                    child: Column(
                      ...
                      width: 70,
                      height: 30,
                      text: 'Book now',buttonTextStyle: button.copyWith(fontSize: 10),)
                      ],
                    ),
                  )),
                  Expanded(flex: 1,child: Container(
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: NetworkImage('${ApiUrls.baseUrl}${event.event_img_1}' ?? placeholderImage),fit: BoxFit.cover),
                    ),
                  )),
                ],
              ),
